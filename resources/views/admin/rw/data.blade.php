...
@section('title', 'Data User RW')

@section('content')
<div class="container-xl">
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3 class="card-title">Data User RW</h3>
            <a href="{{ route('admin.rw.create') }}" class="btn btn-sm btn-primary">Tambah RW</a>
        </div>

        <div class="card-body">
            <form action="{{ route('admin.dataRW') }}" method="GET" class="row g-2 mb-3">
                <div class="col-md-9">
                    <input type="text" name="search" class="form-control" placeholder="Cari nama atau email" value="{{ old('search', $search ?? '') }}">
                </div>
                <div class="col-md-3 d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Cari</button>
                    <a href="{{ route('admin.dataRW') }}" class="btn btn-outline-secondary">Reset</a>
                </div>
            </form>
            ...
            <div class="table-responsive">
                <table class="table table-vcenter card-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted">Belum ada data user RW.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
