          ...
          <ul class="navbar-nav pt-lg-3">
            ...
            <li class="nav-item m-2 dropdown ">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route ('admin.dataWarga') }}"> Data Warga </a>
                <a class="dropdown-item" href="{{ route ('admin.dataRT') }}"> RT </a>
                <a class="dropdown-item" href="{{ route ('admin.dataRW') }}"> RW </a>
                <a class="dropdown-item" href="{{ route ('admin.dataLurah') }}"> Lurah </a>
              </div>
            </li>
            <li class="nav-item m-2 dropdown ">
              <a class="nav-link dropdown-toggle" href="#navbar-form" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false">
            ...
            <li class="nav-item m-2 ">
              <a class="nav-link" href="{{ route('admin.dataJenisSurat') }}">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                ...
                <span class="nav-link-title"> Jenis Surat </span>
              </a>
            </li>
            <li class="nav-item m-2 ">
              <a class="nav-link" href="./">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
                    ...
                    <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7"></path>
                    <path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6"></path></svg></span>
                <span class="nav-link-title"> Pengajuan Surat </span>
              </a>
            </li>
            <li class="nav-item m-2 ">
              <a class="nav-link" href="./">
                <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler.io/icons/icon/home -->
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-1">
                    ...
                    <path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7"></path>
                    <path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6"></path></svg></span>
                <span class="nav-link-title"> Arsip Surat </span>
              </a>
            </li>
            <li class="nav-item m-2 ">
              <a class="nav-link" href="./">
