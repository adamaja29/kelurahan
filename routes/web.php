...
Route::middleware(['role:admin'])->group(function () {
    ...
    Route::get('/admin/wilayah/rw/create', [adminController::class, 'createWilayahRW'])->name('admin.wilayah.rw.create');
    Route::post('/admin/wilayah/rw', [adminController::class, 'storeWilayahRW'])->name('admin.wilayah.rw.store');
    ...
    Route::get('/admin/wilayah/rt/create', [adminController::class, 'createWilayahRT'])->name('admin.wilayah.rt.create');
    Route::post('/admin/wilayah/rt', [adminController::class, 'storeWilayahRT'])->name('admin.wilayah.rt.store');
